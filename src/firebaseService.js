...
// Salvar requisição de captura VTT
export const saveVTTCaptureRequest = async (data) => {
  return saveToFirebase('vtt/captureRequest', data)
}

// Escutar requisição de captura VTT (tempo real)
export const subscribeToVTTCaptureRequest = (callback) => {
  return subscribeToFirebase('vtt/captureRequest', callback)
}
